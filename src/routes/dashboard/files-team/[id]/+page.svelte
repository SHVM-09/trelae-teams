...
<svelte:head>
	<title>{file.name} - Team Files</title>
	<meta name="description" content={`View details for ${file.name}`} />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
</svelte:head>

<div class="max-w-7xl mx-auto py-24 relative z-10 px-6">
	<a href="/dashboard/team-files" class="text-sm text-blue-600 hover:underline flex items-center gap-1 mb-2">
